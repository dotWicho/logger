...
- What SHA of logger are you running? If this is not the latest SHA on the master branch, please try if the problem persists with the latest version.
- If you see anything out of the ordinary, please include it.
